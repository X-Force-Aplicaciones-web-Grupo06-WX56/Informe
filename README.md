...
|-----------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Trabaja en equipo para proporcionar liderazgo en forma conjunta                               | **Alessandro Ramiro Condori Lozano** <br> ***TB1:*** He colaborado con el equipo para completar todas las tareas relacionadas con el perfil de la startup, incluyendo la descripción de la misma y los perfiles de los integrantes del equipo. Juntos hemos trabajado en el perfil de la solución, abordando los antecedentes y la problemática, así como el proceso de Lean UX. Además, en conjunto hemos desarrollado las declaraciones de problemas de Lean UX, las suposiciones, las hipótesis, el Lean UX Canvas y hemos identificado los segmentos objetivo. <br> **Ivan Jeanpierre La Madrid Lozano** <br> ***TB1:*** He colaborado con el equipo en todas las tareas relacionadas con la especificación de requisitos. Esto incluye el mapeo conjunto de escenarios futuros (To-Be Scenario Mapping), la creación colaborativa de User Stories, el Impact Mapping y la elaboración en equipo del Product Backlog. <br> **Jeremy Paucar Meneses** <br> ***TB1:*** He colaborado con el equipo en todas las tareas relacionadas con las directrices de estilo 5/35, tanto generales como para la web. Juntos hemos trabajado en la arquitectura de la información, abordando sistemas de organización, etiquetado, SEO y meta tags, así como en los sistemas de búsqueda y navegación. Además, hemos diseñado en equipo la interfaz de usuario de la página de aterrizaje, creando wireframes y maquetas. <br> **Jimena Alessandra Cossio Jimenez** <br> ***TB1:*** He colaborado con el equipo en todas las tareas relacionadas con la implementación, validación y despliegue del producto. Esto incluye la gestión conjunta de la configuración del software, la configuración del entorno de desarrollo, la gestión del código fuente, la guía de estilo y convenciones del código fuente, y la configuración para el despliegue del software. Además, en equipo hemos implementado la página de aterrizaje, los servicios y las aplicaciones. <br> **Jose Manuel Pariona Lucas** <br> ***TB1:*** He colaborado con el equipo en todas las tareas relacionadas con la elicitación y análisis de requisitos. Esto incluye el análisis competitivo y la formulación conjunta de estrategias y tácticas frente a competidores. También hemos diseñado, registrado y analizado entrevistas en equipo. Además, hemos llevado a cabo actividades de needfinding, desarrollando en conjunto User Personas, User Task Matrix, User Journey Mapping, Empathy Mapping y As-is Scenario Mapping. Finalmente, hemos trabajado en el desarrollo del lenguaje ubicuo.| A lo largo de los diferentes proyectos, se destaca una dinámica de trabajo en equipo donde cada integrante colabora activamente en la realización de las tareas, desde la especificación de requisitos hasta la implementación del producto. Las metas y objetivos se alcanzan a través de la cooperación y el liderazgo compartido, asegurando que todos los miembros participen de manera equitativa en la toma de decisiones y la ejecución de las tareas clave. Esta forma de liderazgo colaborativo permite abordar los desafíos de manera más eficiente y fortalecer la cohesión del equipo.                                     |
| Crea un entorno colaborativo e inclusivo, establece metas, planifica tareasy cumple objetivos | **Alessandro Ramiro Condori Lozano** <br> ***TB1:*** He trabajado junto con el equipo en un entorno colaborativo e inclusivo para completar todas las tareas relacionadas con el perfil de la startup. Esto incluyó establecer metas claras para la descripción de la startup y los perfiles de los integrantes, y planificar las tareas para abordarlas de manera eficiente. También, como equipo, definimos los objetivos para el perfil de la solución, incluyendo los antecedentes, la problemática y el proceso de Lean UX. Además, hemos desarrollado en conjunto las declaraciones de problemas de Lean UX, las suposiciones, las hipótesis, el Lean UX Canvas, y hemos identificado los segmentos objetivo, cumpliendo así los objetivos establecidos. <br> **Ivan Jeanpierre La Madrid Lozano** <br> ***TB1:***  En un entorno inclusivo y colaborativo, el equipo y yo hemos llevado a cabo todas las tareas relacionadas con la especificación de requisitos. Establecimos metas claras para el mapeo de escenarios futuros (To-Be Scenario Mapping), la creación de User Stories, el Impact Mapping y la elaboración del Product Backlog, y planificamos cada tarea para asegurar el cumplimiento de nuestros objetivos. <br> **Jeremy Paucar Meneses** En un entorno colaborativo e inclusivo, el equipo y yo hemos completado todas las tareas relacionadas con las directrices de estilo 5/35, tanto generales como para la web. Juntos, establecimos metas claras para la arquitectura de la información, abarcando sistemas de organización, etiquetado, SEO y meta tags, y planificamos nuestras tareas para cumplir con los sistemas de búsqueda y navegación. También, en equipo, diseñamos la interfaz de usuario de la página de aterrizaje, creando wireframes y maquetas. En cuanto al diseño UX/UI de aplicaciones web, establecimos objetivos para desarrollar wireframes, diagramas de flujo, maquetas y diagramas de flujo de usuario, y planificamos el trabajo para crear prototipos. Además, en colaboración, hemos diseñado la arquitectura de software, elaborando diagramas de contexto, contenedores y componentes. Finalmente, diseñamos la base de datos y su diagrama, cumpliendo las metas establecidas. <br> ***TB1:*** <br> **Jimena Alessandra Cossio Jimenez** <br> ***TB1:***  Junto con el equipo, en un entorno colaborativo e inclusivo, hemos completado todas las tareas relacionadas con la implementación, validación y despliegue del producto. Establecimos metas y planificamos la gestión de la configuración del software, la configuración del entorno de desarrollo, la gestión del código fuente y las convenciones del código, asegurando que cada tarea cumpliera con los objetivos. También, en colaboración, implementamos la página de aterrizaje, los servicios y las aplicaciones, alcanzando las metas trazadas para el despliegue del software. <br> **Jose Manuel Pariona Lucas** <br> ***TB1:*** En un entorno colaborativo e inclusivo, el equipo y yo hemos completado todas las tareas relacionadas con la elicitación y análisis de requisitos. Juntos, establecimos metas para el análisis competitivo y la formulación de estrategias y tácticas frente a competidores, planificando cada tarea para cumplir los objetivos propuestos. En equipo, diseñamos, registramos y analizamos entrevistas. Además, hemos colaborado en actividades de needfinding, desarrollando User Personas, User Task Matrix, User Journey Mapping, Empathy Mapping y As-is Scenario Mapping, y cumpliendo con las metas propuestas. Finalmente, trabajamos en conjunto en el desarrollo del lenguaje ubicuo. <br> | Los proyectos reflejan un entorno inclusivo donde la colaboración es central. Se establecen metas claras en cada etapa del proceso, desde la elicitación de requisitos hasta la arquitectura de software y la implementación final. El equipo se organiza mediante la planificación cuidadosa de las tareas, asignando responsabilidades de manera equitativa y asegurando que los objetivos se cumplan. Esta estructura fomenta la participación activa de todos los miembros y permite que el trabajo se realice de manera eficiente y alineada con los objetivos establecidos, lo que contribuye al éxito de cada fase del proyecto.| 
---
# Contenido
## Tabla de contenidos
...
- [| Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerarquicos, en el marco del desarrollo de un proyecto en ingeniería. | **Alessandro Ramiro Condori Lozano**  ***TB1:*** Mi principal avance fue realizar todo el capitulo I del trabajo final.  **Ivan Jeanpierre La Madrid Lozano**  ***TB1:*** Mi principal avance fue realizar todo el capitulo III del trabajo final.  **Jeremy Paucar Meneses**  ***TB1:*** Mi principal avance fue realizar todo el capitulo IV del trabajo final.  **Jimena Alessandra Cossio Jimenez**  ***TB1:*** Mi principal avance fue realizar todo el capitulo V del trabajo final.  **Jose Manuel Pariona Lucas**  ***TB1:*** Mi principal avance fue realizar todo el capitulo II del trabajo final.| Las entrevistas son una herramienta esencial para el needfinding en el desarrollo de software. Al hablar con los usuarios, hemos aprendido sobre dos nuevos segmentos objetivos definidos y pudimos identificar las necesidades en base a sus experiencias y opiniones.  Asimismo, conocer los competidores permiten la evaluación de un panorama más amplio en el desarrollo de la aplicación. |](#-comunica-en-forma-escrita-ideas-yo-resultados-con-objetividad-a-público-de-diferentes-especialidades-y-niveles-jerarquicos-en-el-marco-del-desarrollo-de-un-proyecto-en-ingeniería--alessandro-ramiro-condori-lozano--tb1-mi-principal-avance-fue-realizar-todo-el-capitulo-i-del-trabajo-final--ivan-jeanpierre-la-madrid-lozano--tb1-mi-principal-avance-fue-realizar-todo-el-capitulo-iii-del-trabajo-final--jeremy-paucar-meneses--tb1-mi-principal-avance-fue-realizar-todo-el-capitulo-iv-del-trabajo-final--jimena-alessandra-cossio-jimenez--tb1-mi-principal-avance-fue-realizar-todo-el-capitulo-v-del-trabajo-final--jose-manuel-pariona-lucas--tb1-mi-principal-avance-fue-realizar-todo-el-capitulo-ii-del-trabajo-final-las-entrevistas-son-una-herramienta-esencial-para-el-needfinding-en-el-desarrollo-de-software-al-hablar-con-los-usuarios-hemos-aprendido-sobre-dos-nuevos-segmentos-objetivos-definidos-y-pudimos-identificar-las-necesidades-en-base-a-sus-experiencias-y-opiniones--asimismo-conocer-los-competidores-permiten-la-evaluación-de-un-panorama-más-amplio-en-el-desarrollo-de-la-aplicación-)
- [Contenido](#contenido)
...
![image](https://github.com/user-attachments/assets/b9e352a3-8d07-4a70-b985-1ca0dfa87af9)
![image](https://github.com/user-attachments/assets/1a1b2c25-4a9e-41db-88d4-3c21b68acc35)

### 2.1.2. Estrategias y  tacticas frente a competidores
Entre las principales estrategias para superar a nuestros competidores tenemos:
●	Diferenciación en el Servicio: Mejorar la personalización de nuestros servicios, entendiendo y adaptando nuestras soluciones a las necesidades específicas de cada cliente.
●	Modelo de Precios Competitivo: Ofreceremos una estructura de precios más accesible, con opciones flexibles adaptadas a diferentes necesidades.
